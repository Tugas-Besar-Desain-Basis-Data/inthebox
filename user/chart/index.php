                                        ...
                                        <div class="quantity">
                                            <div>
                                                ...
                                                <form method="POST" action="proses.php">
                                                    ...
                                                    <input type="hidden" name="id" value="<?php echo $chart['id_chart'] ?>">
                                                    <input type="hidden" name="max" value="<?php echo $max ?>" >
                                                    <input type="number" name="jumlah" class="pro-qty" min ="<?php echo $min ?>" max="<?php echo $max; ?>" placeholder=<?php echo $jumlah_barang ?>>

                                            </div>
                                        </div>
                                    </td>
                                    <td class="total-price first-row"><?php echo "Rp ". number_format($total_barang, 0, ".", "."). "" ?></td>
                                    <td class="close-td first-row"><a href="hapus.php?id=<?php echo $chart['id_chart'] ?>"><i class="ti-close"></i></a></td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-4">
                            <div class="proceed-checkout">
                                <ul>
                                    <li class="subtotal">Subtotal <span><?php echo "Rp ". number_format($total_chart, 0, ".", "."). "" ?></span></li>
