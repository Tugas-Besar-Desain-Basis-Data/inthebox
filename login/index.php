...
if (isset($_GET['pesan'])) {
    ...
    else if ($_GET['pesan'] == "daftarsukses2") {
		echo "<script>alert('Pendaftaran Berhasil, Silahkan Tunggu Konfirmasi Yang Akan Dikirimkan Melalui Email. Anda Tetap Bisa Login Sebagai User. Enjoy')</script>";
    }
