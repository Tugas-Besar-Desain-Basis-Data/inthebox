            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a href="index.php">Question From User</a></li>
                 ...
                 <aside class="col-md-3 sidebar97239">
                    ...
                    <div class="recent-post3290">
                        ...
                        <?php
                            ...
                            $get_data_id = "SELECT * FROM barang_dagang where username='$user'";
                            $data_id_get = $koneksi->query($get_data_id);

                            while($datass_id = mysqli_fetch_assoc($data_id_get)){
                            ...
                            while (($row = mysqli_fetch_array($data_ask)) && ($rows = mysqli_fetch_array($data_time)) ){
                                if($row['barang_id']==$datass_id['id_barang']){
