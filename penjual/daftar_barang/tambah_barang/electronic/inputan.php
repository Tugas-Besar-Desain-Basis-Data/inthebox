...
<html>
	...
	<body>
		...
		<div class="wrapper" style="background-image: url('assets/images/DSDOU3CKQNAUPNV2H5PZPJ4D4E.jpg');">
			<div class="inner">
				<div class="image-holder">
					<img src="assets/images/elektronik.png" alt="">
				</div>
				<form action="index_electronic.php" method="POST">
					<h3>Input Banyak Variasi Yang Diinginkan</h3>
                    <br></br>
                    <br></br>
					<div class="form-wrapper">
						<select name="ukuran" id="pilih" class="form-control" required="required">
							<option value="" disabled selected>Jumlah Tipe Yang Ingin Diinput</option>
                    ...
                    <br></br>
					<div class="form-wrapper">
						<select name="warna" id="pilih" class="form-control" required="required">
                    ...
                    <br></br>
					<div class="form-wrapper">
						<select name="motif" id="pilih" class="form-control" required="required">
							<option value="" disabled selected>Jumlah Merk Yang Ingin Diinput</option>
                            <option value="satu">1</option>
							<option value="dua">2</option>
							<option value="tiga">3</option>
							<option value="empat">4</option>
